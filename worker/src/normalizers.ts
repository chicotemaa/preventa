...
const productAbbreviationPatterns: Array<[RegExp, string]> = [
  ...
  [/\bfco\.|\bfco\b/gi, "frasco "],
  [/\bdp\.|\bdp\b/gi, "doypack "],
  [/\blc\.|\blc\b/gi, "la campagnola "],
  [/\barc\.|\barc\b/gi, "arcor "],
  [/\btab\.|\btab\b/gi, "tableta "],
  [/\bunt\.|\bunt\b/gi, "untable "],
  [/\brep\.|\brep\b/gi, "reposteria "],
  [/\bfliar\.|\bfliar\b/gi, "familiar "],
  [/\bmr\.|\bmr\b/gi, "mister "],
  [/\bevolu\.|\bevolu\b/gi, "evolution "],
  [/\batom\.|\batom\b/gi, "atomic "],
  [/\bh\./gi, "harina "],
