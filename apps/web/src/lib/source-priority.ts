...
export const sourcePriorityConfig: SourcePriorityConfig[] = [
  ...
  {
    sourceId: "kucher-mayorista",
    aliases: ["kucher", "cucher", "kucher mayorista", "cucher mayorista"],
    displayName: "Kucher",
    channel: "mayorista",
    priority: 1,
    criticalForDecision: true,
    ...
    fallbackMessage: "Fuente esperada para pricing mayorista; falta integrar catalogo o credenciales.",
  },
  {
